...
function Item(props: ItemProps): JSX.Element {
  ...
  const hasContent =
    props.trunk.value?.content !== null &&
    props.trunk.value?.content !== undefined
  const hasLink =
    props.trunk.value?.link !== null && props.trunk.value?.link !== undefined
  const hasNote =
    props.trunk.value?.note !== null &&
    props.trunk.value?.note !== undefined &&
    childs.length === 0
  const hasFocus =
    props.focusAncestors !== null && props.focusAncestors.length === 0
  const listItem = (
    <li>
      <div>
        <Decoration
